...
<nav class="navbar navbar-inverse navbar-expand-md bg-dark navbar-dark" style="">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" href="art_and_photography_club_event_search.php" style="">Search</a>
      </li>
      <li class="nav-item">
...
<div class="card-deck" style="margin: auto">
  <?php
    $result = $conn->query("SELECT * FROM art_and_photography_club_event WHERE name = '$search'") or die($conn->error);
...
<form action="art_and_photography_club_event_search_list.php" method="post">
    <div class="search-box" style="margin-top: 350px">
