...
<div class="card-deck" style="margin: auto">
  <?php
    $result = $conn->query("SELECT * FROM young_entrepreneurs_society WHERE ID = '$search'") or die($conn->error);
    ...
    <div class="card" style="background: #000; width: 500px">
      ...
      <div class="card-body text-center">
        ...
        <a href="young_entrepreneurs_society_delete_list.php?delete=<?php echo $row['ID']?>" style="margin-left: 0px; border: 1px solid #fff; padding: 5px 5px 5px 5px">Delete</a>
      </div>
    </div>
  <?php endwhile; ?>
</div>
<form action="young_entrepreneurs_society_delete_list.php" method="post">
  ...
  <?php
    if(isset($_GET['delete'])){
      $delete = $conn->query("DELETE FROM young_entrepreneurs_society WHERE ID = $delete") or die($conn->error);
      header('location:young_entrepreneurs_society_delete.php');
    } 
  ?>
