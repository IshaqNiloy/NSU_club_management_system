...
<html lang="en">
<head>
  <title>Pharmaceuticals Club</title>
  <meta charset="utf-8">
...
<nav class="navbar navbar-inverse navbar-expand-md bg-dark navbar-dark">
  <a class="navbar-brand" href="pharmaceutical_club.php">NSU Club Management</a>
...
<div class="container">
  <h1 style="color: #fff;">Pharmaceuticals Club Form</h1>
  <div class="row">
    <div class="col-sm-3"></div>
    <div class="col-sm-6" style="background-color: rgb(0,0,0,0.5)">
    <form action="pharmaceutical_club_savedata.php" method="post">
    <div class="row">
        <div class="col-sm-12">
