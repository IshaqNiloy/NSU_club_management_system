...
<html lang="en">
<head>
  <title>Young Entrepreneurs Society Club</title>
  <meta charset="utf-8">
...
<nav class="navbar navbar-inverse navbar-expand-md bg-dark navbar-dark">
  <a class="navbar-brand" href="young_entrepreneurs_society.php">NSU Club Management</a>
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" href="young_entrepreneurs_society_search.php">Search</a>
      </li>
...
<div class="container">
  <h1 style="color: #fff;">Young Entrepreneurs Society Club Form</h1>
  <div class="row">
    <div class="col-sm-3"></div>
    <div class="col-sm-6" style="background-color: rgb(0,0,0,0.5)">
    <form action="young_entrepreneurs_society_savedata.php" method="post">
    <div class="row">
        <div class="col-sm-12">
