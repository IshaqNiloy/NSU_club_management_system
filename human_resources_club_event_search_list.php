...
<div class="card-deck" style="margin: auto">
  <?php
    $result = $conn->query("SELECT * FROM human_resources_club_event WHERE name = '$search'") or die($conn->error);
...
<form action="human_resources_club_event_search_list.php" method="post">
