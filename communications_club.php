    ...
    <div class="card-deck">
      <div class="card" style="background-color: ">
        ...
        <div class="card-body text-center">
          ...
          <a href="communications_club_form.php" style="background-color: #00cc66;" target="_blank">More</a>
      </div>
      <div class="card">
        ...
        <div class="card-body text-center">
          ...
          <a href="communications_club_delete.php" style="background-color: #ff6666;" target="_blank">More</a>
      </div>
      <div class="card">
        ...
        <div class="card-body text-center">
          ...
          <a href="communications_club_update.php" style="background-color: #66b2ff;">More</a>
      </div>
      <div class="card" style="background-color: ">
        ...
        <div class="card-body text-center">
          ...
          <a href="communications_club_form.php" style="background-color: rgb(96,189,174)" target="_blank">More</a>
      </div>
    </div>
    </div>
</div>
