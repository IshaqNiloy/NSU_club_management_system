...
<nav class="navbar navbar-inverse navbar-expand-md bg-dark navbar-dark">
  <a class="navbar-brand" href="sangskritkik_sangathan.php">NSU Club Management</a>
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" href="sangskritkik_sangathan_search.php" target="_blank">Search</a>
      </li>
...
<div class="container">
  <h1 style="color: #fff;">Sangskritkik Sangathan</h1>
  <div class="row">
    <div class="col-sm-3"></div>
    <div class="col-sm-6" style="background-color: rgb(0,0,0,0.5)">
    <form action="sangskritkik_sangathan_event_savedata.php" method="post">
    <div class="row">
        <div class="col-sm-12">
