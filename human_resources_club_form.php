...
<body style="background-image: linear-gradient(to bottom right, #30cfd0 0%, #330867 100%);" >
...
<div class="container">
  <h1 style="color: #fff;">Human Resources Club Form</h1>
  <div class="row">
    <div class="col-sm-3"></div>
    <div class="col-sm-6" style="background-color: rgb(0,0,0,0.5)">
    <form action="human_resource_club_savedata.php" method="post">
    <div class="row">
        <div class="col-sm-12">
