...
<nav class="navbar navbar-inverse navbar-expand-md bg-dark navbar-dark">
  <a class="navbar-brand" href="marketing_club.php">NSU Club Management</a>
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" href="marketing_club_search.php">Search</a>
      </li>
...
<div class="container">
  <h1 style="color: #fff;">Markrting Club</h1>
  <div class="row">
    <div class="col-sm-3"></div>
    <div class="col-sm-6" style="background-color: rgb(0,0,0,0.5)">
    <form action="marketing_club_event_savedata.php" method="post">
    <div class="row">
        <div class="col-sm-12">
