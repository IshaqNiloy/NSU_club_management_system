...
<nav class="navbar navbar-inverse navbar-expand-md bg-dark navbar-dark">
  <a class="navbar-brand" href="law_and_mooting_society.php">NSU Club Management</a>
...
<div class="container">
  <h1 style="color: #fff;">Law and Mooting Society</h1>
  <div class="row">
    <div class="col-sm-3"></div>
    <div class="col-sm-6" style="background-color: rgb(0,0,0,0.5)">
    <form action="law_and_mooting_society_event_savedata.php" method="post">
    <div class="row">
        <div class="col-sm-12">
