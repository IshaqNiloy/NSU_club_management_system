...
<nav class="navbar navbar-inverse navbar-expand-md bg-dark navbar-dark" style="">
  <a class="navbar-brand" href="model_un_club.php" class="">NSU Club Management</a>
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" href="model_un_club_search.php" style="">Search</a>
      </li>
      <li class="nav-item">
...
<div class="card-deck" style="margin: auto">
  <?php
    $result = $conn->query("SELECT * FROM model_un_club WHERE ID = '$search'") or die($conn->error);
    ...
    <div class="card" style="background: #000; width: 500px">
      ...
      <div class="card-body text-center">
        ...
        <a href="model_un_club_delete_list.php?delete=<?php echo $row['ID']?>" style="margin-left: 0px; border: 1px solid #fff; padding: 5px 5px 5px 5px">Delete</a>
      </div>
    </div>
  <?php endwhile; ?>
</div>
<form action="model_un_club_delete_list.php" method="post">
  ...
  <?php
    if(isset($_GET['delete'])){
      $delete = $conn->query("DELETE FROM model_un_club WHERE ID = $delete") or die($conn->error);
      header('location:model_un_club_delete.php');
    } 
  ?>
