...
<div class="card-deck" style="margin: auto">
  <?php
    $result = $conn->query("SELECT * FROM law_and_mooting_society_event WHERE name = '$search'") or die($conn->error);
...
<form action="law_and_mooting_society_event_search_list.php" method="post">
