...
<div class="card-deck" style="margin: auto">
  <?php
    $result = $conn->query("SELECT * FROM pharmaceuticals_club_event WHERE name = '$search'") or die($conn->error);
...
<form action="pharmaceutical_club_event_search_list.php" method="post">
