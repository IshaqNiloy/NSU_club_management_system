...
<nav class="navbar navbar-inverse navbar-expand-md bg-dark navbar-dark">
  <a class="navbar-brand" href="finance_club.php">NSU Club Management</a>
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" href="finance_club_search.php">Search</a>
      </li>
...
<div class="container">
  ...
  <div class="row">
    ...
    <form action="finance_club_event_savedata.php" method="post">
    <div class="row">
        <div class="col-sm-12">
