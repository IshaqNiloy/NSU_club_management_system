...
--
-- Host: localhost
-- Generation Time: Apr 09, 2019 at 05:02 PM
...
('Ishaq Ali', 1530869042, 1676766793, 'B+', '45/2, Gana', '', 'Programmin', 'Web development', 'Reading books'),
('Ishaq Ali', 1530869042, 1676766793, 'B+', 'ECE', '45/2, Ganaktuli, Hazaribagh, Dhaka-1205', 'Programmin', 'Web development', 'Reading books');
COMMIT;
