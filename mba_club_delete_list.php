...
<nav class="navbar navbar-inverse navbar-expand-md bg-dark navbar-dark" style="">
  <a class="navbar-brand" href="mba_club.php" class="">NSU Club Management</a>
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" href="mba_club_search.php" style="">Search</a>
      </li>
      <li class="nav-item">
...
<div class="container-fluid">
  <h1 style="color: #000; margin-bottom: 20px">MBA Club</h1>
  <div class="row"> 
<div class="card-deck" style="margin: auto">
  <?php
    $result = $conn->query("SELECT * FROM mba_club WHERE ID = '$search'") or die($conn->error);
    ...
    <div class="card" style="background: #000; width: 500px">
      ...
      <div class="card-body text-center">
        ...
        <a href="mba_club_delete_list.php?delete=<?php echo $row['ID']?>" style="margin-left: 0px; border: 1px solid #fff; padding: 5px 5px 5px 5px">Delete</a>
      </div>
    </div>
  <?php endwhile; ?>
</div>
<form action="mba_club_delete_list.php" method="post">
  ...
  <?php
    if(isset($_GET['delete'])){
      $delete = $conn->query("DELETE FROM mba_club WHERE ID = $delete") or die($conn->error);
      header('location:mba_club_delete.php');
    } 
  ?>
