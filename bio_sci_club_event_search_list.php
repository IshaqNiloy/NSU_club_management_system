...
<div class="card-deck" style="margin: auto">
  <?php
    $result = $conn->query("SELECT * FROM bio_sci_club_event WHERE name = '$search'") or die($conn->error);
...
<form action="bio_sci_club_event_search_list.php" method="post">
    <div class="search-box" style="margin-top: 400px">
      <input class="search-text" type="text" name = "search" placeholder="Enter the the name of the event" >
