...
<div class="card-deck" style="margin: auto">
  <?php
    $result = $conn->query("SELECT * FROM young_economists_forum_event WHERE name = '$search'") or die($conn->error);
...
<form action="young_economists_forum_event_search_list.php" method="post">
