    ...
    <div class="card-deck">
      <div class="card" style="background-color: ">
        ...
        <div class="card-body text-center">
          ...
          <a href="athletics_club_form.php" style="background-color: #00cc66;">More</a>
      </div>
      <div class="card">
        ...
        <div class="card-body text-center">
          ...
          <a href="athletics_club_delete.php" style="background-color: #ff6666;">More</a>
      </div>
      <div class="card" style="background-color: ">
        ...
        <div class="card-body text-center">
          ...
          <a href="athletics_club_search.php" style="background-color: rgb(96,189,174)">More</a>
      </div>
      <div class="card">
        ...
        <div class="card-body text-center">
          ...
          <a href="athletics_club_event_form.php" style="background-color: rgb(252,173,52);">More</a>
      </div>
      <div class="card">
        ...
        <div class="card-body text-center">
          ...
          <a href="athletics_club_event_search.php" style="background-color: #66b2ff;">More</a>
      </div>
    </div>
    </div>
</div>
