...
<div class="container-fluid">
  <h1 style="color: #000; margin-bottom: 20px">Welcome To Art and Photography Club</h1>
  <div class="row">
    <div class="card-deck">
      <div class="card" style="background-color: ">
        ...
        <div class="card-body text-center">
          ...
          <a href="art_and_photography_club_form.php" style="background-color: #00cc66;">More</a>
      </div>
      <div class="card">
        ...
        <div class="card-body text-center">
          ...
          <a href="art_and_photography_club_delete.php" style="background-color: #ff6666;">More</a>
      </div>
       <div class="card" style="background-color: ">
        ...
        <div class="card-body text-center">
          ...
          <a href="art_and_photography_club_search.php" style="background-color: rgb(96,189,174)">More</a>
      </div>
      <div class="card">
        ...
        <div class="card-body text-center">
          ...
          <a href="art_and_photography_event_form.php" style="background-color: rgb(252,173,52);">More</a>
      </div>
      <div class="card">
        ...
        <div class="card-body text-center">
          ...
          <a href="art_and_photography_club_event_search.php" style="background-color: #66b2ff;">More</a>
      </div>
    </div>
    </div>
</div>
