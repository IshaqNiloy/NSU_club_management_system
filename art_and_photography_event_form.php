...
<html lang="en">
<head>
  <title>art and photography event</title>
  <meta charset="utf-8">
...
<nav class="navbar navbar-inverse navbar-expand-md bg-dark navbar-dark">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" href="art_and_photography_club_search.php">Search</a>
      </li>
...
<div class="container">
  <h1 style="color: #fff;">art and photography</h1>
  <div class="row">
    <div class="col-sm-3"></div>
    <div class="col-sm-6" style="background-color: rgb(0,0,0,0.5)">
    <form action="art_and_photography_club_event_savedata.php" method="post">
    <div class="row">
        <div class="col-sm-12">
