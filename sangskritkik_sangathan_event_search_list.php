...
<div class="container-fluid">
  <h1 style="color: #000; margin-bottom: 20px">Sangskritkik Sangathan</h1>
  <div class="row"> 
<div class="card-deck" style="margin: auto">
  <?php
    $result = $conn->query("SELECT * FROM sangskritkik_sangathan_event WHERE name = '$search'") or die($conn->error);
...
<form action="sangskritkik_sangathan_event_search_list.php" method="post">
